...
/**
 * TailwindCSS configuration for DMATHS Learning Hub.
 *
 * Brand palette (exposed as CSS variables in globals.css so both light/dark
 * themes and shadcn/ui semantic tokens resolve against the same source):
 *   Primary  #2563EB   Dark #0F172A   White #FFFFFF   Accent #14B8A6
 */
const config: Config = {
  darkMode: ["class"],
  content: [
  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // Raw brand values for gradients/decoration where semantic tokens don't fit.
        brand: {
          50: "#eff6ff",
          100: "#dbeafe",
          500: "#2563eb",
